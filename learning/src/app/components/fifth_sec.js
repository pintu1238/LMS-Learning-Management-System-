...
// import Cisco from "../../../public/images/third_sec1.webp";
...
//               <Image src={Cisco} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
//           <div className="brand">
//             <div className="brand_img">
//               <Image src={Ericsson_logo} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
//           <div className="brand">
//             <div className="brand_img">
//               <Image src={HPE} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
...
//           <div className="brand">
//             <div className="brand_img">
//               <Image src={Samsung} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
//           <div className="brand">
//             <div className="brand_img">
//               <Image src={Vimeo_Logo} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
//           <div className="brand">
//             <div className="brand_img">
//               <Image src={Volk} alt=".." title='..' fetchPriority='low' />
//             </div>
//           </div>
//         </SwiperSlide>
//         <SwiperSlide>
